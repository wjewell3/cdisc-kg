  ...
  return (
    <div className="app">
      <header className="header">
        ...
        <span className="header-kg-key"><span className="header-kg-dot" />= Knowledge Graph</span>
        <a className="header-github" href="https://github.com/wjewell3/cdisc-kg" target="_blank" rel="noopener noreferrer" title="View source on GitHub">
