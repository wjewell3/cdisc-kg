...
const PALETTE = ["#58a6ff","#79c0ff","#d29922","#ed8936","#39d2c0","#f778ba","#8b949e","#c9d1d9","#79c0ff","#56d364"];
      ...
      {regions.map((r, i) => (
        <div key={r.region} className="geo-bar-row">
          ...
          <div className="geo-bar-track">
            <div className="geo-bar-fill" style={{ width: `${Math.max((r.trial_count / max) * 100, 3)}%`, background: "#39d2c0" }} />
          </div>
